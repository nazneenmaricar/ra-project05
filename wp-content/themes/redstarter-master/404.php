...
<content class="flex">
	<div id="primary" class="content-area flex dir-col flex-grow-1 ">
		<!--  -->
		<main id="main" class="site-main padding-30" role="main">

			<section class="error-404 not-found">
				<header class="page-header">
					<h1 class="page-title text-upper"><?php echo esc_html( 'Oops! That page can&rsquo;t be found.' ); ?></h1>
				</header><!-- .page-header -->
				...
				<div class="page-content">
					...
					<div class="widget widget_categories">
						<h2 class="widget-title text-upper"><?php echo esc_html( 'Most Used Categories' ); ?></h2>
						<ul>
						<?php
